...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", 2000.0, new DateTime(1979, 3, 18), d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", 1600.0, new DateTime(1995, 8, 12), d2);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", 1400.0, new DateTime(1993, 9, 10), d3);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", 2500.0, new DateTime(1996, 12, 15), d1);
            Seller s6 = new Seller(6, "Alex Pink", "pink@gmail.com", 1200.0, new DateTime(1991, 5, 30), d4);
